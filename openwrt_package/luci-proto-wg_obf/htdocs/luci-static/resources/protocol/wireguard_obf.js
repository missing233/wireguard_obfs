...
return network.registerProtocol('wireguard_obf', {
	getI18n: function() {
		return _('WireGuard_Obfuscated VPN');
	},
	...
	renderFormOptions: function(s) {
		...
		o = s.taboption('peers', form.SectionValue, '_peers', form.GridSection, 'wireguard_obf_%s'.format(s.section));
		o.depends('proto', 'wireguard_obf');
	...
	deleteConfiguration: function() {
		uci.sections('network', 'wireguard_obf_%s'.format(this.sid), function(s) {
